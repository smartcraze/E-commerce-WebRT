...
const ProductPage = (props) => {
  ...
  return (
    <div className="rounded-lg overflow-hidden shadow-lg border border-gray-200 transition duration-300 transform hover:scale-105 p-2 m-2 max-w-xs shadow-md"> {/* Added shadow-md class here */}
